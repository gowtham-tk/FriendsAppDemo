...
export default function Login(){
    ...
    <div className="min-h-screen" style={{ textAlign: 'center', margin: '20px 0', alignItems: 'center'  }}>
        {success && <Alert message="Login Successful!" type="success" showIcon></Alert>}
        {error && <Alert message="UnSuccessful Login!" type="error" showIcon></Alert>}

        <div style={{ margin: "20px 20px"}}>
            <Text strong style={{ fontSize: '20px', color: '#1890ff' }}>Login Page</Text>
        </div>
        <br></br>
